...
import "../../src/oracle/StrikePoolUMA.sol";
import "../../src/StrikeController.sol";
import "../../src/mocks/MockERC721.sol";
import "../../src/mocks/MockERC20.sol";
import "../../src/interfaces/IStrikePoolOracle.sol";
import "../../src/AuctionManager.sol";
import "../../src/libraries/OptionPricing.sol";
import "../../src/mocks/MockOracle.sol";
import "./CommonOptimisticOracleV3Test.sol";

contract CommonStrikeTestOracle is Test, CommonOptimisticOracleV3Test {
    AuctionManager public auctionManager;
    StrikeController public strikeController;
    IStrikePoolOracle public strikePoolProxy;
    StrikePoolUMA public strikePoolV1;
    ...
    function _commonSetup() public {
        ...
        strikePoolV1 = new StrikePoolUMA();
        ...
        strikePoolProxy = IStrikePoolOracle(
            strikeController.deployPool2(address(erc721),address(defaultCurrency),address(optimisticOracleV3))
        );
